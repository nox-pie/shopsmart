...
| `ECS_TASK_EXECUTION_ROLE_ARN` | Optional. Needed only if you enable ECS provisioning (`TF_VAR_enable_ecs=true`) and run Phase 3 in an account that allows ECS task execution roles. |
